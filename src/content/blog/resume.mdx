...
<details>
  <summary>Sätra Trafikskola</summary>
  <p>
    I have developed a website that allows the user to solve tests before the
    theory test. This was my first freelance work where I got it from the place
    where I got my where I took my driving test.
  </p>
</details>

<details>
  <summary>Socium</summary>
    [Socium](https://github.com/MuhammedKpln/socium) is a side project, it is an application that is the easiest way to
    chat with people anonymously. It's made with React Native, while it's also
